<x-app-layout>
  ...
  <div
    class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 tabs mb-6">
    <ul class="flex flex-wrap -mb-px">
      <li class="mr-2">
        <a href="#" class="active">Podstawowe
          informacje</a>
      </li>
      <li class="mr-2">
        <a href="#" class="" aria-current="page">Projekty</a>
      </li>
      <li class="mr-2">
        <a href="#" class="">Korespondencja</a>
      </li>
    </ul>
  </div>
    ...
    <div class="border-t border-gray-200">
      <dl>
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 font-semibold">ID: {{$contract->id}}</dd>
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Pełna nazwa zadania</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{$contract->taskName}}</dd>
        </div>
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Skrócona nazwa kontraktu</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{$contract->shortName}}</dd>
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Numer umowy</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{$contract->contractNumber}}</dd>
        </div>
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Data podpisania umowy</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">b/d</dd>
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">

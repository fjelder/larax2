<svg {{ $attributes->merge(['class' => 'rotate-180']) }} viewBox="0 0 38 48" fill="none"
  ...
  <rect x="19.1501" y="19.1667" width="13.5529" height="13.5529" transform="rotate(-135 19.1501 19.1667)" fill="#059669"
    class="fill-primary-300 dark:fill-primary-300/50" />
  ...
  <rect x="28.7335" y="28.75" width="13.5529" height="13.5529" transform="rotate(-135 28.7335 28.75)" fill="#34D399"
    class="fill-primary-900" />
  <path d="M38.3169 38.3333L28.7335 28.75L38.3169 19.1666V29.5486V38.3333Z" fill="#059669"
    class="fill-primary-400 dark:fill-primary-400" />
